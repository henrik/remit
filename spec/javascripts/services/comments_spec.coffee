...
describe "Service: Comments.markAsResolved", ->
  ...
  it "tells the server it was resolved and returns a promise", ->
    inject (Comments, $httpBackend) ->
      ...
      comment = { id: 123 }
      rval = Comments.markAsResolved(comment, "charles@babbage.com")
      expect(typeof(rval.success)).toEqual("function")

      $httpBackend.flush()

describe "Service: Comments.markAsNew", ->
  ...
  it "tells the server it was marked as new", ->
    inject (Comments, $httpBackend) ->
      ...
      comment = { id: 123 }
      rval = Comments.markAsNew(comment, "charles@babbage.com")
      expect(typeof(rval.success)).toEqual("function")
